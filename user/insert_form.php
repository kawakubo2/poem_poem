	...
	<form id="fm" method="POST" action="insert_process.php">
		<div class="container">
			...
			<input type="text" id="username" name="username"
				value="<?=isset($_SESSION['insert_username']) ? e($_SESSION['insert_username']) : '' ?>" />
		</div>
		<div class="container">
    		<label for="name">名前:</label><br>
    		<input type="text" id="name" name="name"
    			value="<?=isset($_SESSION['insert_name']) ? e($_SESSION['insert_name']) : '' ?>" />
		</div>
		<div class="container">
			<label for="email">Eメールアドレス:</label><br>
			<input type="email" id="email" name="email"
				value="<?=isset($_SESSION['insert_email']) ? e($_SESSION['insert_email']) : '' ?>" />
		</div>
		<div class="container">
